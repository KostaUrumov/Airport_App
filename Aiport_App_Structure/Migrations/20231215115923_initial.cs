    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AircraftsFlights", x => new { x.AircraftId, x.FlightId });
                    table.ForeignKey(
                        name: "FK_AircraftsFlights_Aircrafts_AircraftId",
                        column: x => x.AircraftId,
                        principalTable: "Aircrafts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AircraftsFlights_Flights_FlightId",
                        column: x => x.FlightId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AircraftsFlights_FlightId",
